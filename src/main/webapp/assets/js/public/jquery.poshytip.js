...
/* ������ʾ�������ʾ��Ϣ */
function getFocus(){
	if($(".getFocus").length > 0) $(".getFocus").getFocus();
}
/**
* �ı�����������������Ӧ�߶�
* @param                {HTMLElement}        �����Ԫ��
* @param                {Number}                ���ù��������򱣳ֵľ���(Ĭ��0)
* @param                {Number}                �������߶�(��ѡ)
*/
...
(function($) {
	...
	$.Poshytip = function(elm, options) {
		...
		this.$tip = $(['<div class="',this.opts.className,'">',
					   '<span class="marktips_ico"></span>',
					   '<div class="marktips_font_div"><span class="marktips_font">Tip:</span></div>',
	...
	$.fn.poshytip.defaults = {
		...
		className:		'questionmarksimple',	// class for the tips
		...
		alignY:			'top',		// vertical alignment for the tip relative to the mouse cursor or the target elefment
